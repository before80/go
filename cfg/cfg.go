...
type DefaultConfig struct {
	...
	GodEntranceUrl                string `mapstructure:"god_entrance_url"`
	...
	PydEntranceUrl                string `mapstructure:"pyd_entrance_url"`
	PHPdPreFolderName             string `mapstructure:"phpd_pre_folder_name"`
	PHPdEntranceUrl               string `mapstructure:"phpd_entrance_url"`
	MySQLdPreFolderName           string `mapstructure:"mysqld_pre_folder_name"`
	MySQLdEntranceUrl             string `mapstructure:"mysqld_entrance_url"`
